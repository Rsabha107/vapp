...
namespace App\Http\Controllers\Vapp\Auth;
...
use App\Models\Vapp\FunctionalArea as MdsFunctionalArea;
...
class AdminController extends Controller
{
    ...
    public function logout(Request $request): RedirectResponse
    {
        ...
        return redirect('/vapp/auth/login');
    } // End method
    ...
    {
        $events = MdsEvent::all();
        return view('vapp.auth.sign-up', compact('events'));
    }
