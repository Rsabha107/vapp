$(document).ready(function () {
    ...
    $("body").on("click", "#offcanvas-add-match", function () {
        console.log("inside #offcanvas-add-project");
        // $("#add_edit_form").get(0).reset()
        // console.log(window.choices.removeActiveItems())
        $("#cover-spin").show();
        $("#offcanvas-add-match-modal").offcanvas("show");
        $("#cover-spin").hide();
    });

    $("body").on("click", "#edit_match_offcanv", function () {
        console.log("inside #edit_match_offcanv");
        $("#cover-spin").show();
        var id = $(this).data("id");
        ...
        $.ajax({
            url: "/vapp/setting/match/mv/get/" + id,
            method: "GET",
            async: true,
    ...
    // delete project
    $("body").on("click", "#delete_match", function (e) {
        var id = $(this).data("id");
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/vapp/setting/match/delete/" + id,
                    type: "DELETE",
                    headers: {
