$(document).ready(function () {
    ...
    $("#offcanvas-add-parking-capacity-modal").on("hidden.bs.offcanvas", function (e) {
        $(this)
    ...
    $("body").on("click", "#offcanvas-add-parking-capacity", function () {
        console.log("inside #offcanvas-add-project");
        // $("#add_edit_form").get(0).reset()
        // console.log(window.choices.removeActiveItems())
        $("#cover-spin").show();
        $("#offcanvas-add-parking-capacity-modal").offcanvas("show");
        $("#cover-spin").hide();
    });

    $("body").on("click", "#edit_parking_capacity_offcanv", function () {
        console.log("inside #edit_parking_capacity_offcanv");
        $("#cover-spin").show();
        var id = $(this).data("id");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#global-edit-parking-capacity-content").empty("").append(g_response);
                $("#add_project_table").val(table);
                $("#offcanvas-edit-parking-capacity-modal").offcanvas("show");
                $("#cover-spin").hide();
            },
    ...
    // delete project
    $("body").on("click", "#delete_parking_capacity", function (e) {
        var id = $(this).data("id");
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/vapp/setting/parking/delete/" + id,
                    type: "DELETE",
                    headers: {
