                    ...
                    <div class="card shadow-sm">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <div class="text-center mb-4">
                                ...
                                @endif
                                <form action="{{ route('reset.first.password.post') }}" method="POST" class="mt-5">
                                    @csrf
                                    <input type="hidden" name="ft_token" value="{{ $token }}">
                                    <input class="form-control mb-2" name="email" id="email" type="email" placeholder="Type your email" required>
                                    {{-- <input class="form-control mb-2" name="token" id="token" type="password" placeholder="Enter token" required autocomplete="token"> --}}
