        ...
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table id="parking_table"
                    ...
                    data-url="{{ route('vapp.setting.parking.list')}}"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="parking_code">Parking #</th>
                            <th data-sortable="true" data-field="venue">Venue</th>
                            <th data-sortable="true" data-field="vehicle_type">Vehicle Type</th>
                            <th data-sortable="true" data-field="vapp_size">VAPP Size</th>
                            <th data-sortable="true" data-field="capacity">Capacity</th>
