...
<div class="card mt-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <div class="mx-2 mb-2">
                <table id="vapp_variation_table"
                    data-toggle="table"
                    data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                    data-loading-template="loadingTemplate"
                    data-url="{{ route('vapp.setting.parking.variation.list')}}"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="functional_area">FA</th>
                            <th data-sortable="true" data-field="venue">Venue Code</th>
