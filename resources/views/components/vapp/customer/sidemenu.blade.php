            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('vapp/customer/booking')||Request::is('vapp/customer/booking/create')||Request::is('vapp/manager/booking') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                ...
                                @hasrole('Manager')
                                <li class="nav-item"><a class="nav-link {{ Request::is('vapp/manager/booking') ? 'active' : '' }}" href="{{route('vapp.manager.booking')}}">
