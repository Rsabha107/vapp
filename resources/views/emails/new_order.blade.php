...
<head>
    ...
    <title>CMS Confirmation for a New Booking Request: {{ $details['order_ref_number'] }}</title>
</head>
<body>
<h1>CMS Ref#: {{ $details['order_ref_number'] }}</h1>

Dear MDS User,<br> 

<p>We are pleased to confirm that your booking request for has been successfully added to the schedule.<br />
