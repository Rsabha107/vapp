...
<head>
    ...
    <title>MDS Confirmation for a New Booking Request</title>
</head>
<body>
<h1>MDS Ref#</h1>
...
<p>We are pleased to confirm that your booking request for {{ $details['venue'] }} on has been successfully added to the schedule.
