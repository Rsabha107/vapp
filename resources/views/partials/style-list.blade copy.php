...
<!-- <link href="{{ asset ('assets/css/theme-default.css') }}" type="text/css" rel="stylesheet" id="style-default"> -->
...
<!-- <link href="{{ asset ('assets/css/core.css') }}" type="text/css" rel="stylesheet" id="user-style-default"> -->
