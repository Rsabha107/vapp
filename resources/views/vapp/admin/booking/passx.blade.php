...
<body>
    ...
    <div class="invoice-box">
        <table>
            ...
            <tr>
                <td colspan="2">
                    <h4 class="centertext">Master Delivery Schedule (MDS)<br>Booking Ref: <b>{{ $booking->booking_ref_number }}</b></h4>
                </td>
            </tr>
            ...
            <tr class="heading">
                <td colspan="2">Company: {{$booking->booking_party_company_name}}</td>
