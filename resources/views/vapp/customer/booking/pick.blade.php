                        ...
                        <div class="row justify-content-center align-items-center g-5">
                            ...
                            <div class="col-12 col-lg-6 text-center text-lg-start"><img
                                ...
                                <div
                                    ...
                                    <form class="position-relative" action="{{ route('vapp.customer.booking.event.switch') }}" method="POST">
                                        @csrf
                                ...
                                {{-- @endhasrole --}}
                                <a class="btn btn-lg btn-secondary w-100" href="{{ route('vapp.customer') }}">Request Access</a>
                            </div>
                        </div>
                    </div>
                </div>
