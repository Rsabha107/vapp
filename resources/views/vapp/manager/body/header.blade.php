@php
    ...
    //     $event = App\Models\Vapp\VappEvent::findOrFail($current_event_id);
                        ...
                        @foreach ($user_events as $event)
                            @if (session()->get('EVENT_ID') == $event->id)
                                <a class="dropdown-item" id="offcanvas-add-project"
                                    href="{{ route('vapp.customer.booking.switch', $event->id) }}"
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="overflow-auto scrollbar" style="height: 10rem;">
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                ...
                                <li class="nav-item"><a class="nav-link px-3 d-block" href="{{ route('vapp.customer.dashboard') }}"><span
                                            class="me-2 text-body align-bottom"
