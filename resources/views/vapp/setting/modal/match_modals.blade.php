<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-edit-match-modal" tabindex="-1"
    ...
    <div class="offcanvas-body">
        <div class="row">
            <div class="col-sm-12">
                <form class="row g-3 needs-validation form-submit-event" id="edit_match_form" novalidate=""
                    action="{{ route('vapp.setting.match.update') }}" method="POST">
                    @csrf
                    <div id="global-edit-match-content"></div>
                </form>
            </div>
        </div>
    </div>
...
<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-add-match-modal" tabindex="-1"
    aria-labelledby="offcanvasWithBackdropLabel">
    <a class="close-task-detail in" id="close-task-detail" style="display: block;" data-bs-dismiss="offcanvas">
        <span>
