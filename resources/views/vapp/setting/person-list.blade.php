                                ...
                                <th class="no-sort"></th> -->
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="javascript:void(0)" class="btn btn-sm " id="personEditX" data-toggle="modal" data-target='#editModal' data-route="person" data-id="{{ $item->id }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('tracki.setup.person.delete',$item->id)}} " class="btn btn-sm  delete" id="delete">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.setup.person.create') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-top">
            <div class="modal-content bg-100">
                ...
                <form class="needs-validation" novalidate="" action="{{ route('tracki.setup.person.update') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="modal-body px-0">
                            <div class="row g-4">
